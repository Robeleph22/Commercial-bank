...
class Covid19Donation extends StatefulWidget {
  const Covid19Donation({Key? key}) : super(key: key);

  @override
  State<Covid19Donation> createState() => _Covid19DonationState();
}

class _Covid19DonationState extends State<Covid19Donation> {
  @override
          ...
          body: SingleChildScrollView(
              child: Column(
                  children: [
                    ...
                    Text("Covid 19 Donation",style: TextStyle(color: Colors.purple.shade800,fontSize: 18,fontWeight: FontWeight.bold)),
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              ...
                              Navigator.push(context, MaterialPageRoute(builder: (context) => Covid19Payment()));
                            },
                            child: ListTile(
                              leading: Container(
                                height: 40,
