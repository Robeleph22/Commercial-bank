...
class OwnPayment extends StatefulWidget {
  const OwnPayment({Key? key}) : super(key: key);

  @override
  State<OwnPayment> createState() => _OwnPaymentState();
}

class _OwnPaymentState extends State<OwnPayment> {
