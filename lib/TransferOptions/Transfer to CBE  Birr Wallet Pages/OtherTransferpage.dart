...
import 'OthersPayment.dart';
import 'TransfertoCBEBirrwall.dart';

class OtherTransferPage extends StatefulWidget {
  const OtherTransferPage({Key? key}) : super(key: key);

  @override
  State<OtherTransferPage> createState() => _OtherTransferPageState();
}

class _OtherTransferPageState extends State<OtherTransferPage> {
  @override
          ...
          body: SingleChildScrollView(
              child: Column(
                  children: [
                    ...
                    Text("Transfer to Other CBEBirr Account",style: TextStyle(color: Colors.purple.shade800,fontSize: 18,fontWeight: FontWeight.bold)),
                          ...
                          GestureDetector(
                            onTap: () {
                              CircularProgressIndicator(
                               ...
                               Navigator.push(context, MaterialPageRoute(builder: (context) => OthersPayment()));
                            },
                            child: ListTile(
                              leading: Container(
                                height: 40,
