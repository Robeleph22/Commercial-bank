...
class OthersPayment extends StatefulWidget {
  const OthersPayment({Key? key}) : super(key: key);
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    Text('Mobile Number: ',style: TextStyle(color: Colors.black,fontSize: 13,fontWeight: FontWeight.bold),),
                                                    Text(Mobileno.text,style: TextStyle(color: Colors.black,fontSize: 13,fontWeight: FontWeight.bold)),
                                                  ],
                                                ),
